...
import cn.zkw.dialog.utils.DensityUtils;

/**
 * Created by kangzhe on 17/2/7.
 */
        ...
        for(int i = 0;i < rowCount;i++){
            ...
            for(int j= 0 ;j < items.size();j++){
                if(j / MAX_ITEM_COUNT == i){
                    ...
                    iconParam.width = DensityUtils.dip2px(context,25);
                    iconParam.height = DensityUtils.dip2px(context,25);
                    iconParam.topMargin = DensityUtils.dip2px(context,25);
                    ...
                    descParam.topMargin = DensityUtils.dip2px(context,15);
